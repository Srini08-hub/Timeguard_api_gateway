...
@router.get("/status", dependencies=[Depends(verify_reviewer_role)])
...
@router.post("/start", dependencies=[Depends(verify_reviewer_role)])
...
@router.post("/stop", dependencies=[Depends(verify_reviewer_role)])
